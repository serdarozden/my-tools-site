...
export default function HomePage() {
  return (
    <main className="max-w-6xl mx-auto px-4 py-8 sm:py-12">
      ...
      <section className="relative overflow-hidden text-center py-20 px-6 bg-slate-900 border border-slate-800 rounded-3xl mb-16 shadow-2xl">
        {/* Glow Effects & Grid Background */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-50"></div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-blue-400 bg-blue-950/80 border border-blue-800/60 px-4 py-1.5 rounded-full mb-6 backdrop-blur-md">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-xs font-semibold text-slate-300 max-w-xl mx-auto">
            <span className="bg-slate-800/80 border border-slate-700 px-3 py-1.5 rounded-xl">📚 Technical Articles</span>
            <span className="bg-slate-800/80 border border-slate-700 px-3 py-1.5 rounded-xl">🏗️ CAD & Architecture</span>
            <span className="bg-slate-800/80 border border-slate-700 px-3 py-1.5 rounded-xl">⚙️ Engineering Tools</span>
            <span className="bg-slate-800/80 border border-slate-700 px-3 py-1.5 rounded-xl">🖼️ Web3 & Digital Art</span>
          </div>
        </div>
      </section>
      ...
      <section className="mb-16">
        <div className="flex items-center justify-between mb-8 border-b border-slate-800 pb-4">
          <div>
            ...
            <p className="text-sm text-slate-400">In-depth reads, industry standards, and step-by-step tutorials.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 border border-slate-800 rounded-2xl bg-slate-900/60 hover:border-blue-500/50 transition-all duration-200 flex flex-col justify-between group">
            <div>
              <div className="flex items-center gap-2 text-xs font-bold text-blue-400 mb-3">
                <span className="bg-blue-950 border border-blue-800/60 px-2.5 py-1 rounded-md uppercase tracking-wider">Web3 & Art</span>
                <span className="text-slate-600">•</span>
          ...
          {articles.map((article) => (
            <div 
              key={article.slug} 
              className="p-6 border border-slate-800 rounded-2xl bg-slate-900/60 hover:border-blue-500/50 transition-all duration-200 flex flex-col justify-between group"
            >
              <div>
                <div className="flex items-center gap-2 text-xs font-bold text-blue-400 mb-3">
                  <span className="bg-blue-950 border border-blue-800/60 px-2.5 py-1 rounded-md uppercase tracking-wider">{article.category}</span>
                  <span className="text-slate-600">•</span>
                ...
                <p className="text-slate-400 text-sm mb-6 leading-relaxed line-clamp-3">{article.description}</p>
              </div>
              <Link 
