      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 mb-12">
          {currentArticles.map((article) => (
            <article 
              key={article.slug}
              className="p-6 rounded-2xl bg-zinc-950 border border-zinc-800 hover:border-zinc-700 transition-colors shadow-md"
            >
              <div className="flex items-center gap-3 text-xs font-bold text-blue-400 mb-3">
                <span className="bg-zinc-900 border border-zinc-800 px-2.5 py-1 rounded-md uppercase tracking-wider">
                  {article.category}
                </span>
