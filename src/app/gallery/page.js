...
export const metadata = {
  title: 'NFT & Digital Art Showcase - serdarozden.com',
  ...
  return (
    <div className="bg-black min-h-screen text-slate-100">
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        {/* Page Header */}
        <header className="mb-12 pb-8 border-b border-zinc-800 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <span className="bg-zinc-900 border border-zinc-700 text-blue-400 text-xs font-bold px-3 py-1 rounded-md uppercase tracking-wider inline-block mb-4">
              Web3 & Digital Assets
            </span>
          ...
          <div>
            <a 
              ...
              className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold px-6 py-3 rounded-xl transition shadow-lg shadow-blue-600/20"
            >
        ...
        <section className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          {collections.map((item) => (
            <div 
              key={item.id}
              className="p-6 rounded-2xl bg-zinc-950 border border-zinc-800 hover:border-zinc-700 flex flex-col justify-between transition-colors group"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-2xl">{item.emoji}</span>
                  <span className="bg-zinc-900 border border-zinc-700 text-blue-400 text-[10px] font-bold px-2.5 py-1 rounded-md uppercase tracking-wider">
                    {item.badge}
                  </span>
                </div>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 w-full bg-zinc-900 border border-zinc-700 hover:border-blue-500 hover:bg-zinc-800 text-white text-xs font-bold py-3 rounded-xl transition-colors"
              >
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-8 text-center md:text-left md:flex items-center justify-between gap-8">
          <div className="space-y-2 mb-6 md:mb-0">
            <h3 className="text-xl font-bold text-white">Explore the Full OpenSea Profile</h3>
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-block bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold px-6 py-3 rounded-xl transition shadow-md shadow-blue-600/10"
          >
            opensea.io/serdarozden &rarr;
          </a>
        </div>
